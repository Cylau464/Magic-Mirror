...
public class ConditionalHidePropertyDrawer : PropertyDrawer
{
    ...
    private bool GetConditionalHideAttributeResult(ConditionalHideAttribute condHAtt, SerializedProperty property)
    {
        ...
        if (sourcePropertyValue != null)
        {
            enabled = CheckPropertyType(sourcePropertyValue, condHAtt.EnumIndex1);
        ...
        if (sourcePropertyValue2 != null)
        {
            bool prop2Enabled = CheckPropertyType(sourcePropertyValue2, condHAtt.EnumIndex2);
        ...
        for (int index = 0; index < conditionalSourceFieldArray.Length; ++index)
        {
            ...
            int enumFromArray = condHAtt.EnumIndexes[index];
            //if (!property.isArray)
            {
                string propertyPath = property.propertyPath; //returns the property path of the property we want to apply the attribute to
            ...
            if (sourcePropertyValueFromArray != null)
            {
                bool propertyEnabled = CheckPropertyType(sourcePropertyValueFromArray, enumFromArray);                
    ...
    private bool CheckPropertyType(SerializedProperty sourcePropertyValue, int enumIndex = 0)
    {
        ...
        {                
            ...
            case SerializedPropertyType.Enum:
                return sourcePropertyValue.enumValueIndex == enumIndex;
            default:
