Shader "Overlay Emission"
{
    Properties
    {
        _Color("Color", Color) = (0, 0, 0, 0)
        [HDR]_Emission_Color("Emission Color", Color) = (0.09451762, 0.1292894, 0.3396226, 0)
...
SurfaceDescription SurfaceDescriptionFunction(SurfaceDescriptionInputs IN)
{
    ...
    float4 _Property_88112dd9e948445083b319f300ec0fc0_Out_0 = _Color;
    float4 _Property_f3202c31eeb14bea99011807b193fd05_Out_0 = IsGammaSpace() ? LinearToSRGB(_Emission_Color) : _Emission_Color;
    surface.BaseColor = (_Property_88112dd9e948445083b319f300ec0fc0_Out_0.xyz);
    surface.NormalTS = IN.TangentSpaceNormal;
    surface.Emission = (_Property_f3202c31eeb14bea99011807b193fd05_Out_0.xyz);
    surface.Metallic = 0;
