...
        //public static Vector3 OneV3 = new Vector3(1.0f, 1.0f, 1.0f);
        ...
        public void InitializeProperties()
        {
            ...
            if (Shades != null && Shades.Count > 0)
            {
                ...
                {
                    if (shade.ObjectToShade != null && shade.ObjectToShade.TryGetComponent(out Renderer renderer) == true)
                        _renderers.Add(renderer);
                }
            }
        }

        public void AddShadeObject(GameObject objectToShade, Material materialToChange, Renderer renderer)
        {
            if (Shades == null)
                Shades = new List<Shade>();

            Shades.Add(new Shade(objectToShade, materialToChange));
            _renderers.Add(renderer);
        }
...
            int depth = 24;
    ...
    public class Shade
    {
        ...
        public Shade(GameObject objectToShade, Material materialToChange)
        {
            ObjectToShade = objectToShade;
