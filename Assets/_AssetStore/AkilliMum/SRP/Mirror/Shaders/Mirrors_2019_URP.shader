Shader "AkilliMum/URP/Mirrors/2019"
{
    Properties
    {
        ...
        _Magnification("Magnification", Float) = 0.2
        [ToggleOff]_WaveActivated("Wave Activated", Float) = 1
        _WavesCount("Waves Count", Float) = 1
        _WavesDistance("Waves Distance", Float) = 0
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            #pragma shader_feature _SHOCKWAVE
            ...
            #include "Assets/_AssetStore/AkilliMum/SRP/Mirror/Base/URP/LitInput.hlsl"
            #include "Assets/_AssetStore/AkilliMum/SRP/Mirror/Base/URP/LitForwardPass.hlsl"
        ...
        Pass
        {
            ...
            #include "Assets/_AssetStore/AkilliMum/SRP/Mirror/Base/URP/LitInput.hlsl"
            #include "Assets/_AssetStore/AkilliMum/SRP/Mirror/Base/URP/ShadowCasterPass.hlsl"
        ...
        Pass
        {
            ...
            #include "Assets/_AssetStore/AkilliMum/SRP/Mirror/Base/URP/LitInput.hlsl"
            #include "Assets/_AssetStore/AkilliMum/SRP/Mirror/Base/URP/DepthOnlyPass.hlsl"
        ...
        Pass
        {
            ...
            #include "Assets/_AssetStore/AkilliMum/SRP/Mirror/Base/URP/LitInput.hlsl"
            #include "Assets/_AssetStore/AkilliMum/SRP/Mirror/Base/URP/LitMetaPass.hlsl"
        ...
        Pass
        {
            ...
            #include "Assets/_AssetStore/AkilliMum/SRP/Mirror/Base/URP/LitInput.hlsl"
            #include "Assets/_AssetStore/AkilliMum/SRP/Mirror/Base/URP/Universal2D.hlsl"
